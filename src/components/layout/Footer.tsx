      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b border-paper/10 pb-8 mb-6 gap-6">
        ...
        <div className="flex items-center gap-3 flex-wrap" aria-label="Social media links">
          <a
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-paper/15 bg-paper/[0.04] text-paper/60 hover:text-paper hover:border-paper/40 hover:bg-paper/10 text-[10px] tracking-[0.15em] uppercase transition-all"
